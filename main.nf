...
output:
 set val(name),file("*_change_name.tsv")  into g_134_outputFileTSV0_g_136, g_134_outputFileTSV0_g_144, g_134_outputFileTSV0_g_141
...
output:
 set val(outname),file("${outname}_Final_genotype.tsv")  into g_141_outputFileTSV00
